...
- [x] No restricted assets included
- [x] No private paths, tokens, or credentials
- [x] Figures legible at final size
- [x] Abstract contains actual, not placeholder, results
- [x] Limitations match actual coverage
- [x] Reproduction commands tested
