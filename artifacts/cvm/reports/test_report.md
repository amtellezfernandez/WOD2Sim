...
| Command | Result |
|---|---|
| `./scripts/build_cvm_paper.sh` | Latest controlled pass rebuilt the 6-page root `wod2sim.pdf` at 126866 bytes. |
...
| `qpdf --check wod2sim.pdf && pdfinfo wod2sim.pdf` | Latest controlled pass: 6 pages, portrait A4, 126866 bytes, and no syntax or stream encoding errors reported by `qpdf`. |
