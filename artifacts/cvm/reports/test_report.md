...
| `make conformance PYTHON=./.venv/bin/python` | Passed: 268 passed, 14 skipped, 15 subtests passed. |
| `make demo PYTHON=./.venv/bin/python` | Passed: synthetic demo valid with `valid_claim_evidence=false`. |
| `make cvm-check PYTHON=./.venv/bin/python` | Passed: ruff clean, 268 passed, 14 skipped, 15 subtests passed, validation passed. |
...
| `./.venv/bin/python -m pytest -q` | Passed: 268 passed, 14 skipped, 15 subtests passed. |
...
| Selection | Result |
|---|---|
| `tests -k "semantic or route"` | 10 passed, 272 deselected. |
| `tests -k "temporal or resampl"` | 10 passed, 272 deselected, 15 subtests passed. |
| `tests -k "lifecycle or session"` | 10 passed, 272 deselected. |
| `tests -k "plugin or entry_point"` | 5 passed, 277 deselected. |
| `tests -k "deployment or readiness or launch"` | 20 passed, 262 deselected. |
| `tests -k "evidence or audit or benchmark"` | 21 passed, 261 deselected. |
| `tests -k "fault"` | 5 passed, 277 deselected. |
