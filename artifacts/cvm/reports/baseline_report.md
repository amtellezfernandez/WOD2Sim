...
| `make cvm-check PYTHON=./.venv/bin/python` | 0 | Ruff passed; conformance suite passed with 236 passed, 14 skipped, and 15 subtests passed; paper validation passed. |
